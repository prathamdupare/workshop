...
const Contact = () => {
  return (
    <section id="registrat">
      <div
        id="contact"
        className="bg-gradient-to-r from-gray-800 via-gray-700 to-gray-800 text-white p-4 my-9 px-4 rounded-[20px] shadow-lg flex flex-col items-center justify-center pt-20"
      >
        ...
        <div className="bg-gray-800 p-4 rounded-lg shadow-lg mb-5 w-80 mx-auto">
          ...
          <div className="flex justify-center space-x-4 mb-4 p-4">
            <a
              ...
              className="flex items-center justify-center p-1 text-blue-500"
            >
