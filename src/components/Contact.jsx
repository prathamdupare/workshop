  ...
  return (
    <section id="registration" className="scroll-padding">
      ...
      >
        ...
        <div className="bg-gradient-to-r from-white-500 to-black-500 p-4 rounded-lg shadow-lg my-5 w-[800px] mx-auto">
          <h1 className="text-white font-poppins font-semibold text-2xl text-center ">
          ...
          <div className="flex justify-center space-x-4 mb-4 p-4">
            <a
              ...
              className="flex items-center font-extrabold text-sky-400 text-[20px] p-2 text-blue-500"
            >
              <i className="ri-mail-line text-lg text-white  mr-2"></i>
              ispp_sat@iiserb.ac.in
            </a>
            <a
              href="https://twitter.com/pcdb_lab_iiserb"
              target="_blank"
              className="flex items-center font-extrabold text-sky-400 p-2 text-[20px] text-blue-500"
              rel="noreferrer"
            >
              <i className="ri-twitter-x-fill text-lg text-white mr-2"></i>Tweet
            </a>
          </div>

          <h2 className=" text-white text-[20px] font-extrabold rounded-lg text-center">
            #ISPP24 #EMBOplantBio
          </h2>
        </div>
